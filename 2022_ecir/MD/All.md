...
Peter's preferred definition: $$F_{1} = \frac{TP}{TP + {\color{red}{\frac{FN+FP}{{\color{red}{2}}}}}} = \frac{{\color{red}{2}}TP}{{\color{red}{2}}TP + {\color{red}{{FN+FP}}}}$$ <!-- .element: class="fragment" -->
